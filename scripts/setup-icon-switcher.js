 ...
 *   1. Bemásolja a native/android/IconSwitcherPlugin.java fájlt a megfelelő
 *      package mappába (a capacitor.config.ts appId-je alapján).
 *   2. Regisztrálja a plugint a MainActivity.java-ban.
 *   3. Az AndroidManifest.xml-ben létrehozza az 5 activity-alias elemet
 *      (amber, slate, forest, rose, night) - a MainActivity saját LAUNCHER
 *      intent-filterét eltávolítja, mert mostantól az aliasok biztosítják azt.
 *      Alapból csak az "amber" alias van engedélyezve.
 */
...
function patchManifest() {
  ...
  // Megkeressük a MainActivity <activity> blokkját, benne a LAUNCHER intent-filterrel.
  ...
  // A LAUNCHER intent-filter eltávolítása a MainActivity-ből (az aliasok fogják biztosítani).
